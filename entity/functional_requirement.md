Here are the functional requirements for your application outlined in the form of user stories and use cases, along with the necessary API endpoints, request/response formats, and visual representations using Mermaid diagrams.
...
This structure outlines the necessary functional requirements along with the API details and Mermaid diagrams to visualize user interaction with the application. If any aspects require further clarification or additional user stories should be included, please let me know.